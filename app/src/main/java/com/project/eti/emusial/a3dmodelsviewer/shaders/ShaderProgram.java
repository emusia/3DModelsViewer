package com.project.eti.emusial.a3dmodelsviewer.shaders;
...
public class ShaderProgram
{
    ...
    public int _LightPosHandle=-1;
    public int _ColourHandle=-1;
    ...
    public void getVariableHandles()
    {
        ...
        _LightPosHandle = GLES20.glGetUniformLocation(programHandle, "lightPosition");
        _ColourHandle = GLES20.glGetUniformLocation(programHandle, "lightColour");
